...
public class scriptforCurduprac : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //timerIsRunning = true;
        //score2 = scriptforB.score1;
        //Debug.Log("scroeC" + score2);
        //prevtime = scriptforB.prevtime;
    ...
    public void togglevalue()
    {
        if (mcq1val == true)
        {
            score2 = scriptforBurduprac.score1 + 10;
            Debug.Log("score22" + score2);
        }
        else
        {
            score2 = scriptforBurduprac.score1;
            Debug.Log("score22" + score2);
        }
        //int h = (int)timeRemaining;
        ...
        //Debug.Log("hhdcvbhgsdvcghsdvg" + h);
        //Debug.Log("hhdcvbhgsdvcghsdvg" + temp);
        Application.LoadLevel("ObjectReDUrduPrac");
    }
}
