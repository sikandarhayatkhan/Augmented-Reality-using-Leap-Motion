...
public class scriptforBurduprac : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //timerIsRunning = true;
        //score1 = scriptforA.score;
        //Debug.Log("scroeB" + score1);
        //prevtime = scriptforA.completetime;
    ...
    public void togglevalue()
    {
        if (mcq3val == true)
        {
            score1 = scriptforAurduprac.score + 10;
            Debug.Log("scoreee11" + score1);
        }
        else
        {
            score1 = scriptforAurduprac.score;
            Debug.Log("scoreee11" + score1);
        }
        //int h = (int)timeRemaining;
        ...
        //Debug.Log("hhdcvbhgsdvcghsdvg" + h);
        //Debug.Log("hhdcvbhgsdvcghsdvg" + temp);
        Application.LoadLevel("ObjectReCUrduPrac");
    }
}
