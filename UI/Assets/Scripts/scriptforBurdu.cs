...
public class scriptforBurdu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        timerIsRunning = true;
        score1 = scriptforAurdu.score;
        Debug.Log("scroeB" + score1);
        prevtime = scriptforAurdu.completetime;
    ...
    public void togglevalue()
    {
        if (mcq3val == true)
        {
            score1 = scriptforAurdu.score + 10;
        ...
        //Debug.Log("hhdcvbhgsdvcghsdvg" + h);
        //Debug.Log("hhdcvbhgsdvcghsdvg" + temp);
        Application.LoadLevel("ObjectReCUrdu");
    }
}
