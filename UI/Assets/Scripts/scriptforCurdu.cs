...
public class scriptforCurdu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        timerIsRunning = true;
        score2 = scriptforBurdu.score1;
        Debug.Log("scroeC" + score2);
        prevtime = scriptforBurdu.prevtime;
    ...
    public void togglevalue()
    {
        if (mcq1val == true)
        {
            score2 = scriptforBurdu.score1 + 10;
        ...
        //Debug.Log("hhdcvbhgsdvcghsdvg" + h);
        //Debug.Log("hhdcvbhgsdvcghsdvg" + temp);
        Application.LoadLevel("ObjectReDUrdu");
    }
}
