...
using UnityEditor;
public class collisionurdu2 : MonoBehaviour
{
    ...
    {
        score = 0;
        obj1 = collisionurdu1.obj1;//PlayerPrefs.GetString("obj1name");
        obj2 = collisionurdu1.obj2; // PlayerPrefs.GetString("obj2name");
        obj3 = collisionurdu1.obj3;//PlayerPrefs.GetString("obj3name");
        Debug.Log("obj11" + obj1);
        Debug.Log("obj22" + obj2);
        Debug.Log("obj33" + obj3);
    ...
    {
        if (collision.transform.name == obj2)
        {
